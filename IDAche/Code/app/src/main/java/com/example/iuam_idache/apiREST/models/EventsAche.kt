...
// TODO code weather -> String ou byte ?
class EventsAche {
    var event_id: Long = -1
    ...
    constructor(
        ...
        this.event_code_weather = event_code_weather.toByte()
